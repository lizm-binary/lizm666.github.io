...
;(function ($, window, document, undefined) {
  ...
  Calendar.prototype = {
    showHoverInfo: function (obj) { // hover 时显示当天信息
      var _calendarDom = $('#calendar');
      var _dateStr = $(obj).attr('data');
      var offset_t = $(obj).offset().top - (this.$calendar_today.height() - $(obj).height()) - _calendarDom.offset().top;
      var offset_l = $(obj).offset().left + $(obj).width() - _calendarDom.offset().left;
      ...
      this.$calendar_today
            .css({left: offset_l + 20, top: offset_t})
            .stop()
            .animate({left: offset_l + 12, top: offset_t});
